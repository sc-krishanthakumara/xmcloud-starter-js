...
export const defaultSiteMetadataProps: SiteMetadataProps = {
  ...
  fields: {
    ...
    metadataTitle: createMockField('SYNC Audio - Professional Headphones & Speakers | Premium Sound Equipment'),
    metadataKeywords: createMockField('audio equipment, headphones, speakers, premium sound, professional audio, SYNC, music gear'),
    metadataDescription: createMockField('Discover SYNC\'s premium audio equipment collection. Shop professional headphones, speakers, and sound gear designed for audiophiles and music professionals.'),
  },
};
...
export const siteMetadataPropsMetadataOnly: SiteMetadataProps = {
  ...
  fields: {
    ...
    metadataDescription: createMockField('Professional-grade audio equipment for studios and performers.'),
  },
};
...
export const siteMetadataPropsSpecialChars: SiteMetadataProps = {
  ...
  fields: {
    ...
    metadataTitle: createMockField('SYNC™ Audio - "Premium" Headphones & <Speakers> | Pro Audio Equipment'),
    metadataKeywords: createMockField('ãudio, prõfessional, spëcialty, "quotes", <tags>, &amp; symbols'),
    metadataDescription: createMockField('Discover SYNC™ premium audio with "professional" quality <guaranteed> & specialized equipment for music lovers.'),
  },
};
...
export const siteMetadataPropsLongContent: SiteMetadataProps = {
  ...
  params: {},
  fields: {
    title: createMockField('SYNC Audio Equipment Store - Premium Professional Headphones Speakers and Audio Gear for Musicians'),
    metadataTitle: createMockField('SYNC Audio Equipment Store - Premium Professional Headphones, Speakers, Microphones, Audio Interfaces, Studio Monitors, Mixing Consoles, and Pro Audio Gear for Musicians, Producers, DJs, and Audio Engineers'),
    metadataKeywords: createMockField('professional audio equipment, premium headphones, studio monitors, audio interfaces, mixing consoles, microphones, speakers, pro audio gear, music production equipment, recording studio gear, live sound equipment, DJ equipment, audio accessories, sound engineering tools, professional music gear, studio headphones, reference monitors, audio cables, rack equipment, portable audio'),
    metadataDescription: createMockField('SYNC Audio Equipment Store offers the most comprehensive selection of premium professional audio equipment including headphones, speakers, microphones, audio interfaces, studio monitors, mixing consoles, and specialized pro audio gear designed for musicians, producers, DJs, audio engineers, and music enthusiasts who demand exceptional sound quality and professional-grade performance for recording, mixing, mastering, live performances, and critical listening applications.'),
  },
};
